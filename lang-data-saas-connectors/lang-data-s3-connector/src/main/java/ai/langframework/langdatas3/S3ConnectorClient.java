...
public class S3ConnectorClient implements ConnectorClient {
        ...
        try {
            ...
            switch (prefixName.toUpperCase()) {
                ...
                case "JSON":
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Unsupported file connector type: " + "fileConnectorType");
            }
            return document;
        } catch (Exception e) {
            e.printStackTrace();
     ...
     */
    @Override
    public List<Document> readData(File file) throws LoaderException { return null; }
     ...
     */
    @Override
    public List<Document> readData(String link) throws LoaderException { return null; }

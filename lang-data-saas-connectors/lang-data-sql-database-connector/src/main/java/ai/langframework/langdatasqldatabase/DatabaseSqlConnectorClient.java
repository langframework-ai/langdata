...
public class DatabaseSqlConnectorClient implements ConnectorClient {
    ...
    /**
     * This constructor creates a database connector client with the given
     * driver, URL, username, and password, attempting to establish a connection to the database.
    ...
    /**
     * This function retrieves all rows from a specified database table and returns them as a list of lists.
     * @param tableName
    ...
    /**
     * This function inserts a row into a specified database table with the provided column names and values.
     * @param tableName
     * @param columnValues
     * @throws SQLException
     */
    public void insertIntoTable(String tableName, Map<String, Object> columnValues) throws SQLException {
    ...
    /**
     * This function updates records in a specified database table with the provided updated values based on a given condition.
     * @param tableName
     * @param updatedValues
     * @param condition
     * @throws SQLException
     */
    public void updateRecord(String tableName, Map<String, Object> updatedValues, String condition) throws SQLException {
    ...
    /**
     * This function executes a SQL query and prints the result.

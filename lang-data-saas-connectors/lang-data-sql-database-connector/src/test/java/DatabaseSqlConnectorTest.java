...
class DatabaseSqlConnectorTest {
    ...
    void initializeclient(){
        ...
        Assumptions.assumeTrue(username != null && !username.isEmpty(), "Database username SQL_USERNAMEDB not set");
        Assumptions.assumeTrue(password != null && !password.isEmpty(), "Database url SQL_PASSWORD not set");

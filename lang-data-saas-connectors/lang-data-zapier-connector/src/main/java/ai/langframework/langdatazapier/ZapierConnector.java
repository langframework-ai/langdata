...
public class ZapierConnector implements Connector {
    ...
    /**
     *Constructor method that initializes the zapierConnectorClient with a default constructor of ZapierConnectorClient.
     */
    ...
    /**
     * Constructor method that initializes the zapierConnectorClient with a parameterized constructor of ZapierConnectorClient by passing the access key.
     * @param accessKey
     */
    ...
    /**
     * Initializes the zapierConnectorClient with the current access token. This method ensures that the connector client is properly initialized before usage.
     */
    public void initializeClient()  { zapierConnectorClient = new ZapierConnectorClient(accessToken); }
     ...
     */
    public ZapierConnectorClient getConnectorClient() { return (ZapierConnectorClient) zapierConnectorClient; }

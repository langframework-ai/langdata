...
public class PineconeConnector implements Connector {
    ...
    /**
     * Constructor initializing PineconeConnector with specified API key, environment,
     * project name, index, and connection URL.
     ...
     */
    public PineconeConnector(String apikey, String environment, String projectName, String index, String connectionUrl){
        pineconeClient = new PineconeConnectorClient(apikey, environment, projectName, index, connectionUrl);
    }

    /**
     * Constructor initializing PineconeConnector with specified API key, environment, project name, index, connection URL,
     ...
     */
    public PineconeConnector(String apikey, String environment, String projectName, String index, String connectionUrl, VectorInterface.EmbeddingClientType embeddingClientType, String modelApiKey){
        pineconeClient = new PineconeConnectorClient(apikey, environment, projectName, index, connectionUrl, embeddingClientType, modelApiKey);
    }
     ...
     */
    public void setEmbeddingClientType(VectorInterface.EmbeddingClientType embeddingClientType) { this.embeddingClientType = embeddingClientType; }

...
class PineconeConnectorTest {
    ...
    void initializeClient(){
        Assumptions.assumeTrue(pineconeApiKey != null && !pineconeApiKey.isEmpty(), "PineconeAPI key not set");
        Assumptions.assumeTrue(connectionUrl != null && !connectionUrl.isEmpty(), "PineconeAPI url not set");

...
public class PgvectorConnector implements Connector {
    ...
    /**
     * Constructs a PgvectorConnector with the specified database connection parameters and model API key.
     ...
     */
    public PgvectorConnector(String driver, String url, String username, String password, VectorInterface.EmbeddingClientType embeddingClientType, String modelApiKey) throws SQLException {
        pgvectorConnectorClient = new PgvectorConnectorClient(driver,url,username,password, embeddingClientType, modelApiKey);
    }
    ...
    /**
     * Initializes the PgvectorConnector with the provided database connection parameters and model API key.
     * @throws SQLException if a database access error occurs
     */

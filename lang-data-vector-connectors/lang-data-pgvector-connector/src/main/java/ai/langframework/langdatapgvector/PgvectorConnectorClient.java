...
public class PgvectorConnectorClient implements ConnectorClient, VectorInterface {
    ...
    /**
     * This "PgvectorConnectorClient" constructor initializes a connection to a PostgreSQL database using the provided driver, URL, username, and password.
     * It also enables the "vector" extension and registers the vector type with the database connection, allowing for operations on vector data.
     * @param driver
     * @param url
     * @param username
     * @param password
     */
    public PgvectorConnectorClient(String driver, String url, String username, String password, EmbeddingClientType embeddingClientType, String modelApiKey) throws SQLException {
        connection = null;
        try {
...
//         Register the vector type with your connection
    ...
    /**
     * This "createTable" method dynamically creates a table with the specified name and columns along with their data types.
     * It also adds a primary key constraint to the "id" column, if present, and returns a message indicating the success of the operation.
     * @param tableName
     * @param columns
     * @throws SQLException
     */
    ...
    /**
     * This "insertData" method dynamically inserts data into the specified table using the provided column names and values,
    ...
    /**
     * This "getNearestNeighbors" method retrieves nearest neighbors from the specified table for a given query vector,
     * limited by the provided count, and returns them as a string.
     * @param tableName
     * @param queryVector
     * @param limit
     * @throws SQLException
    ...
    /**
     * Retrieves nearest neighbors from the specified table for a given query vector,
     * limited by the provided count
     * @param tableName
     * @param queryVector
     * @param limit
     ...
     * @throws SQLException
     */
    public List<Map<String, Object>> getNearestNeighborsAsMap(String tableName, float[] queryVector, int limit) throws SQLException {
    ...
    /**
     * The "addIndex" function dynamically creates an index for the specified table using the provided index type,
     * indexing method, and optional additional options.
     * @param tableName
     * @param indexType
     ...
     * @throws SQLException
     */
    public String addIndex(String tableName, String indexType, String indexingMethod, String additionalOptions) throws SQLException {
        String query = "CREATE INDEX ON " + tableName + " USING " + indexType + " (" + indexingMethod + ")";
     ...
     */
    @Override
    public Object getClient() {return connection;}

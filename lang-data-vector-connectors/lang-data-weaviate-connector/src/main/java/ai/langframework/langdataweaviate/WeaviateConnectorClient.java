...
public class WeaviateConnectorClient implements ConnectorClient, VectorInterface {
    ...
    /**
     * Initializes a new Weaviate connector client with the specified URL, API key, embedding client type, and model API key.
     ...
     * @param modelApiKey The API key required for accessing the embedding model (e.g., OpenAI or Cohere).
     */
    public WeaviateConnectorClient(String URL, String apiKey, EmbeddingClientType embeddingClientType, String modelApiKey){
        try{
            Config config = new Config("https", URL);
            client = WeaviateAuthClient.apiKey(config, apiKey);
    ...
    public void createClass(String className, String classDescription, String vectorizer){
        ...
        try {
            weaviateClass = WeaviateClass.builder()
                    .className(className)
    ...
    public void deleteClass(String className){
        ...
        try{
            result = client.schema().classDeleter()
     ...
     */
    public void addDataObject(String className, Map<String, Object> dataSchema, String consistencyLevel){
        try {
     ...
     * @param vector
     */
    public void addDataObjectWithVector(String className, Map<String, Object> dataSchema, Float[] vector){
        try {
            Result<WeaviateObject> result = client.data().creator()
                    .withClassName(className)
                    .withVector(vector)
    ...
    /**
     * Method to perform Similarity search in Weaviate Vector store and return vectors along with fieldNames passed
     * @param text
     * @param className
     * @param fieldName1
     * @return Response Object
     ...
     * @return Response Object
     */
    public Object search(String text, String className, String fieldName1, String fieldName2, String fieldName3){
        try{
            Field field1 = Field.builder()
                    .name(fieldName1)
                    .build();

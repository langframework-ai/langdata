...
public class WeaviateConnector implements Connector {
  ...
  /**
   * Constructor initializing WeaviateConnector with the provided URL, API key, type of embedding
   * client and embedding model key.
   *
   * @param URL
   * @param apiKey
  ...
  public WeaviateConnector(
      ...
      String modelApiKey) {
    weaviateLangDataClient =
        new WeaviateConnectorClient(URL, apiKey, embeddingClientType, modelApiKey);
  }
  ...
  /**
   * Initializes the WeaviateConnectorClient with the configured settings. If the OpenAI key is
   * null, initializes with URL and API key only.
   *
   * @see #setUrl(String)

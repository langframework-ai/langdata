...
public class MilvusConnector implements Connector {
    ...
    public MilvusConnector(String clusterEndpoint, String token, VectorInterface.EmbeddingClientType embeddingClientType, String modelApiKey)
    {
        MilvusConnectorClient = new MilvusConnectorClient(clusterEndpoint,token, embeddingClientType, modelApiKey);
    }

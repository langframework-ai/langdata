...
public class CohereAIConnectorTest {
  ...
  void testClassify() {
    ...
    movieReviews.put(
        "The cinematography and acting were outstanding; a must-watch film!", "Positive");
    movieReviews.put(
        "Unfortunately, the plot was confusing and the characters were underdeveloped.",
        "Negative");
    movieReviews.put(
        "I was on the edge of my seat throughout the entire movie. Thrilling!", "Positive");
    movieReviews.put(
        "The dialogue felt forced, and the pacing was too slow. Disappointing.", "Negative");
    movieReviews.put("A heartwarming and touching story. I highly recommend it.", "Positive");
    movieReviews.put(
        "The special effects were impressive, but the story lacked depth. Mediocre.", "Negative");
    movieReviews.put("An absolute masterpiece! The performances were exceptional.", "Positive");
    movieReviews.put(
        "I expected more from this film. It fell short of my expectations.", "Negative");

    String response =
        connectorClient.classify(
            movieReviews,
            "A visually stunning film with a captivating storyline. I was thoroughly impressed!");

    assertNotNull(response, "Response should not be null");
    assertTrue(
        response.toLowerCase().contains("positive"),
  ...
  void testCallWithContext() throws LoaderException {
    ...
    assertTrue(
        ...
        "The summary should contains information about the connectors");
  }
}

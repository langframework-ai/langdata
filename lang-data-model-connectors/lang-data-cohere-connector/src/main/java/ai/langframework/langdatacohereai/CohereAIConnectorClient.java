...
public class CohereAIConnectorClient implements ConnectorClient {
    ...
    public String simpleChat(String question){
        NonStreamedChatResponse response = client.chat(ChatRequest
                .builder()
                .message(question)
                .build());
    ...
    /**
     * Allows users to have conversations with a Large Language Model (LLM) of their choice from Cohere.
     * @param question
     * @param model
     * @return String response
     */
    ...
    public String simpleGenerate(String question){
        Generation response = client.generate(GenerateRequest
                .builder()
                .prompt(question)
                .build());
    ...
    public String classify(Map<String,String> examples, String question){
        ...
        ClassifyResponse response = client.classify(ClassifyRequest
                .builder()
     ...
     */
    private List<ClassifyRequestExamplesItem> convertMaptoClassifyRequest(Map<String,String> examples){
        List<ClassifyRequestExamplesItem> classifyRequestExamplesItems = new ArrayList<>();

        for (Map.Entry<String, String> entry : examples.entrySet()) {
            classifyRequestExamplesItems.add(ClassifyRequestExamplesItem.builder()
                    .text(entry.getKey())
    ...
    public Float[] embedText(String text){
        EmbedResponse response = client.embed(EmbedRequest
                .builder()
                .addTexts(text)
                .build());

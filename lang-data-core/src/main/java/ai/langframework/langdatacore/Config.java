...
public class Config {
  ...
  public static String getApiKey(String name) {
    // Try to get the API key from the system environment variable. If not found, try to get it from
    // the .env file
    ...
    if (apiKey == null || apiKey.isEmpty()) {
      throw new IllegalStateException(
          "API key is not set in the environment variables or .env file");
    }
    return apiKey;
  }

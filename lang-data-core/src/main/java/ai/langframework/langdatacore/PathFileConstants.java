...
public final class PathFileConstants {
  ...
  private static String hostedFileDomain =
      "https://shared-public-resources-free-ai.s3.amazonaws.com/";
  ...
  // Github file URL
  public static final String GITHUB_FILE_URL =
      "https://github.com/mit-nlp/MITIE/blob/master/tools/wordrep/src/word_vects.cpp";

  // Github issues URL
  public static final String GITHUB_ISSUE_URL =
      "https://github.com/lexfridman/mit-deep-learning/issues";
}
